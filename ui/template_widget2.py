...
# Form implementation generated from reading ui file 'template_widget2.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(_translate("Form", "颜色阈值"))
        self.saveButton.setText(_translate("Form", "保存"))
        self.comboBox.setItemText(0, _translate("Form", "白色"))
        self.comboBox.setItemText(1, _translate("Form", "蓝色"))
        self.comboBox.setItemText(2, _translate("Form", "红色"))
        self.comboBox.setItemText(3, _translate("Form", "黄色"))
        self.comboBox.setItemText(4, _translate("Form", "紫色"))
        self.comboBox.setItemText(5, _translate("Form", "绿色"))
        self.comboBox.setItemText(6, _translate("Form", "黑色"))
