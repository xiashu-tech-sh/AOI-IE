...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.getCircleButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "Get Circle"))
        self.label_4.setText(_translate("Form", "threshold"))
        self.reverseCheckBox.setText(_translate("Form", "reverse"))
        self.getCircleButton.setText(_translate("Form", "Get Circle"))
