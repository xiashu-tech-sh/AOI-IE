    ...
    def Work_thread(self):
        ...
        while True:
            ...
            if ret != 0:
                ...
                continue
            cdll.msvcrt.memcpy(byref(img_buff), stConvertParam.pDstBuffer, nConvertSize)
            print("img_buff,self.st_frame_info.nWidth,self.st_frame_info.nHeight", img_buff)
            print("nWidth,", self.st_frame_info.nHeight)
            print("self.st_frame_info.nWidth", self.st_frame_info.nWidth)
